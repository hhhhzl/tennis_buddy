...
def generate_launch_description():
    ...
    rover_dir = get_package_share_directory('tennisbuddy_planning')
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(rover_dir, 'configs', 'nav2_params.yaml'),
    ...
    perception_path = get_package_share_directory("tennisbuddy_perception")
    rl_launch_path = os.path.join(perception_path, 'launch', 'robot_localizer_outdoor.launch.py')
    ...
    bringup_cmd_group = GroupAction([
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(perception_path, 'launch/slam_launch.py')),
