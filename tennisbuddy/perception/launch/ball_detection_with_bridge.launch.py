...
def generate_launch_description():
    ...
    # --- Ball Detection Bridge (transforms to global coords) ---
    ball_bridge = Node(
        package='tennisbuddy_perception',
        ...
        parameters=[{
            'use_sim_time': sim_time,
            'bbox_topic': '/detections/bboxes',
            'conf_topic': '/detections/confidences',
            'camera_info_topic': caminfo,
            'depth_topic': depth,
            'output_topic': '/ball_positions',
            'target_frame': 'map',
    ...
    return LaunchDescription([
        model, show_viz, start_realsense, color_topic, depth_topic, camera_info_topic, conf, use_sim_time,
        rs_launch,
        detector,
        ball_bridge,
    ])